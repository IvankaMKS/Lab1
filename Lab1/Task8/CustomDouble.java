...
public class CustomDouble {
    ...
    public CustomDouble division(final CustomDouble customDouble) throws ArithmeticException {//div
    ...
    public CustomDouble addition(final CustomDouble customDouble) {// add
        final double result = this.toDouble() + customDouble.toDouble();
        return new CustomDouble(result);
    }

    public CustomDouble subtraction(final CustomDouble second) {//sub
        final double result = this.toDouble() - second.toDouble();
        return new CustomDouble(result);
    }

    public CustomDouble multi(final CustomDouble second) { // код для таск 12
        final double result = this.toDouble() * second.toDouble();
        return new CustomDouble(result);
    }
